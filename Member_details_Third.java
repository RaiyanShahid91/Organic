...
public class Member_details_Third extends AppCompatActivity {
    EditText membercode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_member_details_third);
        ...
        activatebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(Member_details_Third.this,"Enter your member Code",Toast.LENGTH_SHORT).show();
                }
                ...
                if(text.length()>5)
                {
                    ...
                    Toast.makeText(Member_details_Third.this,"Here are all your Details",Toast.LENGTH_SHORT).show();
                }
            }
        });
